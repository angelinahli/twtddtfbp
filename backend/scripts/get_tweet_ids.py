""" Taken a modified from https://github.com/bpb27/twitter_scraping/blob/master/scrape.py """
...
def form_url(since, until):
    p1 = 'https://twitter.com/search?f=tweets&vertical=default&q=finally%20from%3A'
